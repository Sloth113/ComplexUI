    ...
    public override void Apply(GameObject obj)
    {
        switch (m_type)
        {
            case Type.ShakeRot:
                ...
                break;
            case Type.ShakePos:
                iTween.ShakePosition(obj, iTween.Hash("name", m_name, "amount", m_amount, "islocal", false, "time", m_time, "delay", m_delay, "looptype", m_loopType));
                break;
            ...
            case Type.RotateTo:
                ...
                break;
            case Type.MoveTo:
                iTween.MoveTo(obj, iTween.Hash("name", m_name, "position", m_amount, "islocal", m_local, "time", m_time, "delay", m_delay, "easetype", m_easeType, "looptype", m_loopType));//If local goes to anchor 
                break;
            case Type.ScaleAdd:
            ...
            case Type.RotateAdd:
                ...
                break;
            case Type.MoveAdd:
                iTween.MoveAdd(obj, iTween.Hash("name", m_name, "amount", m_amount, "space", m_space, "time", m_time, "delay", m_delay, "easetype", m_easeType, "looptype", m_loopType));
                break;
            case Type.FadeTo:
